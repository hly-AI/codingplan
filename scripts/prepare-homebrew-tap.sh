...
# 输出到 ../homebrew-codingplan/ 供推送到 Gitee
...
echo ""
echo "后续步骤:"
echo "  1. 在 Gitee 创建仓库 project_hub_1/homebrew-codingplan"
echo "  2. cd $TAP_DIR && git init && git add . && git commit -m 'Add codingplan formula'"
echo "  3. git remote add origin git@gitee.com:project_hub_1/homebrew-codingplan.git"
